...
int actions(int flag) {
    ...
    switch (flag) {
        ...
        case 7: {
            cout << "Введите номер матрицы и номер строки и столбца элемента, который вы хотите сетнуть: ";
            cin >> num >> i >> j;
            if (num < 0 || num >= matrices_count || matrices[num] == nullptr) {
                cout << "Матрицы с таким номером нет\n";
            } else {
        ...
        case 8: {
            cout << "Введите номер матрицы и номер строки и столбца элемента, который вы хотите вывести на экран: ";
            cin >> num >> i >> j;
            if (num < 0 || num >= matrices_count || matrices[num] == nullptr) {
                cout << "Матрицы с таким номером нет\n";
            } else {
        ...
        case 9: {
            ...
            cin >> num1 >> num2;
            if (num1 < 0 || num2 < 0 || num1 >= matrices_count || num2 >= matrices_count ||
                matrices[num1] == nullptr || matrices[num2] == nullptr) {
                ...
                cout << "Результат сложения записан в матрицу под номером " << matrices_count << "\n";
                matrices_count++;
            }
            break;
        }
        ...
        case 10: {
            cout << "Введите номера матриц, которые вы хотите вычесть (первая минус вторая): ";
            cin >> num1 >> num2;
            if (num1 < 0 || num2 < 0 || num1 >= matrices_count || num2 >= matrices_count ||
                matrices[num1] == nullptr || matrices[num2] == nullptr) {
                cout << "Матриц с таким номером не существует\n";
                ...
                matrices[matrices_count] = *a - *b;
                cout << "Результат вычитания записан в матрицу под номером " << matrices_count << "\n";
                matrices_count++;
            }
            break;
        }
        ...
        case 11: {
            ...
            matrices[matrices_count] = *a * *b;
            cout << "Результат умножения записан в матрицу под номером " << matrices_count << "\n";
            matrices_count++;
            break;
        }
        ...
        case 12: {
            ...
            cout << "Результат умножения на скаляр записан в матрицу под номером " << matrices_count << "\n";
            matrices_count++;
            break;
        }
        ...
        case 17: {
            ...
            try {
                ...
                if (flag == 16) x = m->SolveSlauGauss(&b);
                else x = m->SolveSlauLU(&b);
        ...
        case 18: {
            if (matrices_count == 0) cout << "Нет доступных для взаимодействия матриц\n";
            else {
                cout << "Доступные для взаимодействия матрицы: ";
                for (int k = 0; k < matrices_count; k++) {
                    if (matrices[k] != nullptr) cout << k << " ";
                }
                cout << "\n";
            }
            break;
